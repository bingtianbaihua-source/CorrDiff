...
PASS if `outputs/augmented_labels.json` exists, has the same number of entries as lines in `inputs/smiles_list.txt`, and each entry contains all 10 property keys.
