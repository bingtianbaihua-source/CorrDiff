import os
import sys
sys.path.append("/home/zhoujingyuan/KGDiff-main/")
import argparse
...
if __name__ == '__main__':
    ...
    pdb_path = '/home/zhoujingyuan/KGDiff-main/data/lpy_protein/AF-A8MUN2-F1-model_v4.pdb'
    ...
    pocket_dest = '/home/zhoujingyuan/KGDiff-main/data/lpy_protein/AF_pocket.pdb'


    pdb_block_pocket = protein.residues_to_pdb_block(
        protein.query_residues_radius([14.7921, 5.0332, -17.1769], 10)
    )
    with open(pocket_dest, 'w') as f:
        f.write(pdb_block_pocket)
